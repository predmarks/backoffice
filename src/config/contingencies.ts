export const CONTINGENCY_TEMPLATES = {
  ...
  event_cancelled: (event: string) =>
    `Si ${event} se cancela o pospone indefinidamente, el mercado se resolverá según las contingencias definidas (en binarios: "No").`,
