...
import { TopicFeedbackInput } from './_components/TopicFeedbackInput';
  ...
  return (
    <div className="max-w-4xl">
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-5 mb-6">
        ...
        <TopicFeedbackInput topicId={topic.id} initialFeedback={topic.feedback ?? []} initialScore={topic.score} />
      </div>
